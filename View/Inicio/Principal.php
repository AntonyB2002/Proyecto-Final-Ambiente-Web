...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
    ...
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            ...
            <a class="navbar-brand logo-text" href="index.html">ShareFlix</a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h1 class="h1-large">The #1 CRM app for <span class="replace-me">small business, young startups,
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>Velit dictum non proin egestas convallis nunc, eu auctor massa. Nam hendrerit, eros ut
                            viverra lobortis, mauris nisi porta risus, placerat dignissim tellus auctor masse</p>
                        <ul class="list-unstyled li-space-lg">
                            <li class="d-flex">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text">Tortor sodales eget. Vivamus imperdiet leo eu
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text">Eros volutpat ante mauris euismod sem, ut varius
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text">Sed congue ex quam, sit amet venenatis dolor
